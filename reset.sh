...
function load_backup() {
    ...
    #wget -q --no-check-certificate -O "$mods_backup_directory/$game_name-backup.zip" "https://www.dropbox.com/scl/fi/9op80agupjr30rgqbxbwv/MX-Bikes-backup.zip?rlkey=v5u1fpfs5wmvtlo18ozbr25sd&dl=0" # do not un #
